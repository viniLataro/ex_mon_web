defmodule ExMon.PokeApi.ClientTest do
  ...
  describe "get_pokemon/1" do
    ...
    test "when there is any pokemon with the given name, returns the error" do
      mock(fn %{method: :get, url: @base_url <> "wrong_pokemon_name"} ->
        %Tesla.Env{status: 404}
      end)

      response = Client.get_pokemon("wrong_pokemon_name")
